...
var arr = ['production-right_1', 'production-right_2', 'production-right_3', 'production-right_4', 'production-right_5', 'production-right_6', 'production-right_7'];
var arr_1 = ['yellow-dot_1', 'yellow-dot_2', 'yellow-dot_3', 'yellow-dot_4', 'yellow-dot_5', 'yellow-dot_6', 'yellow-dot_7'];
var bool = false;
...
document.addEventListener("click", function(e) {
    ...
    if (exam != -1) {      
        if (arr[exam] != text) {
            ...
            document.getElementsByClassName(text_1)[0].style.backgroundColor = 'rgba(0, 0, 0, 0)';
            document.getElementsByClassName(arr_1[exam])[0].style.backgroundColor = 'yellow ';
            document.getElementsByClassName('production-list_li')[privs].classList.remove('production-li_active');
            document.getElementsByClassName('production-list_li')[exam].classList.add('production-li_active');
